...
public class WmsTransactionConfig {

    // 事物管理器
    @Bean("wmsTransactionManager")
    public DataSourceTransactionManager transactionManager(@Qualifier("wmsDatasource") DataSource dataSource){
    ...
    // 通知
    @Bean("wmsTxAdvice")
    public TransactionInterceptor transactionInterceptor(@Qualifier("wmsTransactionManager") DataSourceTransactionManager transactionManager){
    ...
    // 切面
    @Bean
    public Advisor advisor(@Qualifier("wmsTxAdvice") Advice advice){

        AspectJExpressionPointcut aspectJExpressionPointcut = new AspectJExpressionPointcut();

        aspectJExpressionPointcut.setExpression("execution(* com.tastycai.multidatasource.wms.service..*(..))");
