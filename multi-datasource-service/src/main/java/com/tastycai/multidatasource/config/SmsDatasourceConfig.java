...
public class SmsDatasourceConfig {
    ...
    private static String MAPPER_LOCATION = "classpath:com/tastycai/multidatasource/sms/dao/*.xml";;
    ...
    // jdbcTemplate
    @Bean("smsJdbcTemplate")
    JdbcTemplate jdbcTemplate(@Qualifier("smsDatasource") DataSource dataSource){
    ...
    SqlSessionFactory sqlSessionFactory(@Qualifier("smsDatasource") DataSource dataSource) throws Exception {
